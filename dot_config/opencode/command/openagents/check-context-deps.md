...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/c/Users/local/.config/opencode/context/` (direct path references)
    - `@/c/Users/local/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /c/Users/local/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /c/Users/local/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /c/Users/local/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/c/Users/local/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/c/Users/local/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/c/Users/local/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/c/Users/local/.config/opencode/context/core/" (direct paths)
       - "@/c/Users/local/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /c/Users/local/.config/opencode/context/core/:
...
✓ /c/Users/local/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /c/Users/local/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/c/Users/local/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
