...
- Code tasks → /c/Users/local/.config/opencode/context/core/standards/code-quality.md
- Docs tasks → /c/Users/local/.config/opencode/context/core/standards/documentation.md  
- Tests tasks → /c/Users/local/.config/opencode/context/core/standards/test-coverage.md
- Review tasks → /c/Users/local/.config/opencode/context/core/workflows/code-review.md
- Delegation → /c/Users/local/.config/opencode/context/core/workflows/task-delegation.md
...
<execution_priority>
  ...
  <conflict_resolution>
    ...
    - Context files (/c/Users/local/.config/opencode/context/core/*.md) MANDATORY, not optional
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.0" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /c/Users/local/.config/opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read /c/Users/local/.config/opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read /c/Users/local/.config/opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read /c/Users/local/.config/opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read /c/Users/local/.config/opencode/context/core/workflows/task-delegation.md NOW
      ...
      <automatic_loading>
        IF code task → /c/Users/local/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → /c/Users/local/.config/opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → /c/Users/local/.config/opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → /c/Users/local/.config/opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → /c/Users/local/.config/opencode/context/core/workflows/task-delegation.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
     ...
     <route to="Specialist" when="simple_specialist_task">
       ...
       <examples>
         ...
         task(
           ...
           prompt="Context to load:
                   - /c/Users/local/.config/opencode/context/core/workflows/code-review.md
         ...
         task(
           ...
           prompt="Context to load:
                   - /c/Users/local/.config/opencode/context/core/standards/documentation.md
  ...
  <process ref="/c/Users/local/.config/opencode/context/core/workflows/task-delegation.md">Full delegation template & process</process>
</delegation_rules>
...
<static_context>
  Context index: /c/Users/local/.config/opencode/context/index.md
