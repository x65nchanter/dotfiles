...
BEFORE starting task breakdown, ALWAYS:
  1. Load context: `/c/Users/local/.config/opencode/context/core/task-management/navigation.md`
...
- Tasks without status check → Duplicate work, conflicts
  ...
  <interaction_protocol>
    <with_meta_agent>
      ...
      - Do NOT read `/c/Users/local/.config/opencode/context/core/workflows/task-delegation.md` or follow delegation workflows.
    ...
    <stage id="0" name="ContextLoading">
      ...
      <process>
        1. Load task management context:
           - `/c/Users/local/.config/opencode/context/core/task-management/navigation.md`
           - `/c/Users/local/.config/opencode/context/core/task-management/standards/task-schema.md`
           - `/c/Users/local/.config/opencode/context/core/task-management/guides/splitting-tasks.md`
           - `/c/Users/local/.config/opencode/context/core/task-management/guides/managing-tasks.md`
         ...
         3. Create subtask_NN.json for each task:
             ...
             **AGENT FIELD SEMANTICS**:
              ...
              **FRONTEND RULE**: If a task involves UI design, styling, or frontend implementation:
              ...
              2. Include `/c/Users/local/.config/opencode/context/ui/web/ui-styling-standards.md` and `/c/Users/local/.config/opencode/context/core/workflows/design-iteration.md` in `context_files`.
