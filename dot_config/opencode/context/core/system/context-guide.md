...
**Index Location**: `/c/Users/local/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/c/Users/local/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/c/Users/local/.config/opencode/context/core/` with organized subfolders:
...
- Load `/c/Users/local/.config/opencode/context/index.md`
...
### /c/Users/local/.config/opencode/context/core/standards/security-patterns.md
- Error handling
- Security patterns
- Common code patterns

### /c/Users/local/.config/opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /c/Users/local/.config/opencode/context/core/workflows/task-delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /c/Users/local/.config/opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /c/Users/local/.config/opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
