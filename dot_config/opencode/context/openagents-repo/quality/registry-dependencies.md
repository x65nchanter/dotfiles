...
- Code tasks → /c/Users/local/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
```
...
**Path normalization**:
```
File path:     /c/Users/local/.config/opencode/context/core/standards/code-quality.md
...
```
dependencies:
  - context:core/standards/code           # /c/Users/local/.config/opencode/context/core/standards/code-quality.md
  - context:core/standards/docs           # /c/Users/local/.config/opencode/context/core/standards/documentation.md
  - context:core/workflows/delegation     # /c/Users/local/.config/opencode/context/core/workflows/task-delegation.md
...
- context:core/standards/code (referenced 3 times)
  - Line 64: "Code tasks → /c/Users/local/.config/opencode/context/core/standards/code-quality.md"
...
```bash
# Make your changes
vim /c/Users/local/.config/opencode/context/core/standards/code-quality.md
```
...
ls -la /c/Users/local/.config/opencode/context/core/standards/code-quality.md
...
rm /c/Users/local/.config/opencode/context/core/standards/code-analysis.md
./scripts/registry/auto-detect-components.sh --auto-add
```
...
- **Registry Guide**: `/c/Users/local/.config/opencode/context/openagents-repo/guides/updating-registry.md`
- **Registry Concepts**: `/c/Users/local/.config/opencode/context/openagents-repo/core-concepts/registry.md`
- **Adding Agents**: `/c/Users/local/.config/opencode/context/openagents-repo/guides/adding-agent.md`
